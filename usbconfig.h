 ...
 */
#define USB_CFG_VENDOR_NAME     'H','e','a','r','t','s','C','r','y'
...
#define USB_CFG_DEVICE_NAME     'M','i','d','i','S','t','o','m','p'
...
#define USB_CFG_DESCR_PROPS_DEVICE                  USB_PROP_IS_DYNAMIC //was 0
#define USB_CFG_DESCR_PROPS_CONFIGURATION           USB_PROP_IS_DYNAMIC //was 0
